                            ...
                            <div className="flex-1 overflow-hidden p-4 flex flex-col">
                                <div className="flex items-center">
                                    <div className="flex-1 flex flex-row items-baseline">
                                        ...
                                        <p className="text-3xl text-gray-600 mt-2 font-blockkie">{description}</p>
                                    </div>
                                    {getWeatherIcon(description)}
                                </div>
                                <div className="text-4xl mt-4 font-blockkie">
                                    <div className="flex flex-row items-center">
                                        {tempUp} High: {highTemp}°C
                                        {tempDown} Low: {lowTemp}°C
                                    </div>
                                </div>
                            </div>
