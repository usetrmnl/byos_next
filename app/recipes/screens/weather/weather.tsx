...
export default function Weather({
    ...
    const getWeatherIcon = (desc: string) => {
        ...
        if (lowerDesc.includes("rain") || lowerDesc.includes("drizzle")) return RainIcon;
                                ...
                                <div className="w-full flex flex-col mb-4" style={{ gap: "16px" }}>
                                    ...
                                    <div className="w-full flex flex-row" style={{ gap: "16px" }}>
                                        {weatherStats.slice(0, 3).map((stat, index) => (
                                            <div
                                                key={index}
                                                className="p-2 rounded-xl border border-black flex-grow flex flex-row items-center"
                                            >
                                                <div className="p-2">
                                                    {stat.icon}
                                                </div>
