...
export default function WifiConnectModal({
  ...
  return (
    <Dialog>
      ...
      <DialogContent 
        className="block w-full max-w-full md:max-w-5xl p-0 overflow-hidden"
      >
        <ScrollArea className="h-[90vh] w-full overflow-y-auto px-2 md:px-4 lg:px-6">
          <div className="py-4">
            <DialogHeader>
              <DialogTitle className="text-xl text-center mt-2">Connect Your TRMNL Device</DialogTitle>
            </DialogHeader>

            {/* Step 0 - Connect to TRMNL WiFi */}
            <div className="mt-6 pb-6 mb-6 border-b border-gray-200 dark:border-gray-700">
              <h3 className="font-bold text-md">Start by resetting the device,</h3>
              <p className="text-sm text-gray-400 dark:text-gray-600">
                Hold the button at the back of the device for 5 seconds.
              </p>
              <h3 className="font-bold text-md mt-1">...and connect to TRMNL WiFi</h3>
              <p className="text-sm text-gray-400 dark:text-gray-600">
                Connect to the <strong>TRMNL</strong> WiFi network and wait for the captive portal to appear
              </p>
              <div className="mt-2 bg-white dark:bg-gray-800 py-2 px-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex items-center"><WifiIcon className="w-4 h-4 mr-2" /> <span>TRMNL</span></div>
            ...
            <div className="mt-6 flex flex-col space-y-6 md:grid md:grid-cols-2 md:gap-6 md:items-start md:space-y-0">
              ...
              <div className="flex justify-center md:justify-start">
                ...
                <div className="w-[280px] h-auto max-h-[80vh] md:h-[750px] transition-all duration-300 
                  ...
                  <div className="bg-white dark:text-black rounded-[24px] shadow-[0_0_0_8px_#e2e8f0,0_0_0_12px_#94a3b8] overflow-hidden relative w-full translate-x-[12px] translate-y-[12px]">
                    ...
                    <div className="p-3 bg-white rounded-lg min-h-[400px] text-sm sm:min-h-[350px] md:min-h-[450px]">
                      <Image src="/static/trmnl-logo.svg?height=40&width=120" alt="Logo" className="mx-auto w-1/2 mb-4" width={120} height={40} />

                      <h1 className="text-xl font-bold text-center mb-4">Wi-Fi Configuration</h1>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <table className="w-full bg-white overflow-hidden border-spacing-1 border-collapse">
                            <caption className="text-left text-gray-500 pb-1 text-sm">Networks</caption>
                            <tbody>
                              ...
                              <tr className="h-[30px] text-sm bg-gray-50">
                                <th className="text-left pl-2">Neighbor_WiFi</th>
                                <td className="text-right">
                                  <div className="flex items-center justify-end gap-2 pr-2">
                                    <WifiIcon className="w-4 h-4" aria-hidden="true" />
                                    <LockIcon className="w-4 h-4" aria-hidden="true" />
                        ...
                        <div className="relative">
                          ...
                          <div className="flex flex-col items-start w-full relative">
                            ...
                            <div className="relative w-full">
                              ...
                              <EyeIcon className="absolute top-1/2 right-2 -translate-y-1/2 w-4 h-4 text-gray-500" aria-hidden="true" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="relative">
                          ...
                          <div className="border border-gray-300 rounded-lg p-2 bg-gray-50 mb-4 text-xs">
                            <p className="mb-2">
                              This button allows you to specify a custom API server (also known as BYOS) for your
                              device. Most users don&apos;t want this, and will use the official server with their TRMNL. Are
                              you sure you want to have a custom server specified?
                            </p>
                  ...
                  <ol className="list-decimal pl-5 space-y-3">
                    ...
                    <li className="mb-3">
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        From the list of available networks, select the WiFi network you want your IoT device to connect
                        to.
                      </p>
                    </li>
                    ...
                    <li className="mb-3">
                      ...
                      <p className="text-sm text-gray-600 mt-1">Type in the password for your selected WiFi network.</p>
                    </li>

                    <li className="mb-3">
                      <strong>Enable Custom Server</strong>
                      <p className="text-sm text-gray-600 mt-1">
                        Click the <strong>Custom Server</strong> button at the bottom of the screen. When prompted with
                        the confirmation dialog, click <strong>Yes</strong>.
                      </p>
                    </li>
                    ...
                    <li>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Click the <strong>Connect</strong> button to complete the setup.
                      </p>
                    </li>
                  </ol>
                </div>
